        ...
        <div className="products">
            ...
            <div className="d-flex justify-content-center mt-4">
                <div className="w-75">
                    ...
                    <div>
                    Découvrez notre rubrique de location de ski, votre destination pour trouver l'équipement parfait. Skis, chaussures, accessoires : nous avons tout ce dont vous avez besoin. Notre équipe expérimentée vous guidera vers le matériel adapté à votre niveau et à vos préférences. Location flexible pour une journée ou plus. Prêt à dévaler les pentes en toute sécurité ?
                    </div>
                </div>
            </div>
